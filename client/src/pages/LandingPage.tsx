...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fafbff] flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <>
                ...
                <Button 
                  variant="ghost" 
                  className="text-red-600 hover:bg-red-200 hover:text-red-700 shadow-md shadow-red-200/50 gap-2 transition-all" 
      ...
      {/* Hero */}
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-24 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="max-w-7xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 text-indigo-700 text-sm font-semibold px-4 py-1.5 rounded-full mb-8 hover:bg-indigo-100 transition-colors cursor-default">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {isAuthenticated ? (
              ...
              <Button 
                ...
                onClick={() => navigate("/auth")}
              >
                Start Your Assessment <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
            )}
            <Button 
              variant="outline" 
              size="lg" 
              className="h-14 px-8 text-lg rounded-xl border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-300"
          ...
          {/* Stats */}
          <div className="flex items-center justify-center gap-8 md:gap-16 mt-20 text-center animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
            <div>
              <div className="text-4xl font-black text-gray-900">5 <span className="text-xl font-bold text-gray-500">min</span></div>
              <div className="text-sm font-medium text-gray-500 mt-1">Setup Time</div>
            </div>
            <div className="w-px h-12 bg-gray-200" />
            <div>
              <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-indigo-500 to-purple-500">AI</div>
              <div className="text-sm font-medium text-gray-500 mt-1">Adaptive Questions</div>
            </div>
            <div className="w-px h-12 bg-gray-200" />
            <div>
              <div className="text-4xl font-black text-gray-900">PDF</div>
              <div className="text-sm font-medium text-gray-500 mt-1">Export Reports</div>
            </div>
          </div>
        </div>
      </main>
      ...
      <section id="how-it-works" className="py-24 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">How It Works</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            ...
            <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-sm border border-gray-100">
              ...
              <span className="text-gray-700 font-semibold">Powered by Azure OpenAI</span>
            </div>
            <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-sm border border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-gray-500 font-medium">
              Built by{" "}
              <span className="font-bold text-gray-900">Ritik Kumar</span>
            </p>
